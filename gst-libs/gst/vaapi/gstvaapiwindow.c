...
static void
gst_vaapi_window_set_property (GObject * object,
...
static void
gst_vaapi_window_get_property (GObject * object,
...
gst_vaapi_window_class_init (GstVaapiWindowClass * klass)
{
  ...
  g_object_class_install_property
      ...
      g_param_spec_uint ("width",
          "Width", "The window width", 1, G_MAXUINT32, 1, G_PARAM_READWRITE));

  g_object_class_install_property
      (object_class,
      PROP_HEIGHT,
      g_param_spec_uint ("height",
          "height", "The window height", 1, G_MAXUINT32, 1, G_PARAM_READWRITE));
  ...
  g_object_class_install_property
      ...
      g_param_spec_boolean ("fullscreen",
          "Fullscreen",
          "The fullscreen state of the window", FALSE, G_PARAM_READWRITE));
}
 ...
 */
void
gst_vaapi_window_get_size (GstVaapiWindow * window, guint * pwidth,
    guint * pheight)
{
  g_return_if_fail (GST_VAAPI_IS_WINDOW (window));
  g_return_if_fail (window->priv->is_constructed);
