...
gst_vaapi_subpicture_create (GstVaapiSubpicture * subpicture)
{
  ...
  status = vaCreateSubpicture (GST_VAAPI_DISPLAY_VADISPLAY (display),
      GST_VAAPI_OBJECT_ID (priv->image), &subpicture_id);
  GST_VAAPI_DISPLAY_UNLOCK (display);
...
static void
gst_vaapi_subpicture_set_property (GObject * object,
...
static void
gst_vaapi_subpicture_get_property (GObject * object,
...
gst_vaapi_subpicture_class_init (GstVaapiSubpictureClass * klass)
{
  ...
  g_object_class_install_property
      ...
      g_param_spec_object ("image",
          "Image",
          "The GstVaapiImage this subpicture is bound to",
          GST_VAAPI_TYPE_IMAGE, G_PARAM_READWRITE));
}
...
gst_vaapi_subpicture_init (GstVaapiSubpicture * subpicture)
{
  GstVaapiSubpicturePrivate *priv =
      GST_VAAPI_SUBPICTURE_GET_PRIVATE (subpicture);
...
gst_vaapi_subpicture_new (GstVaapiImage * image)
{
  ...
  return g_object_new (GST_VAAPI_TYPE_SUBPICTURE,
      ...
      "id", GST_VAAPI_ID (VA_INVALID_ID), "image", image, NULL);
}
